...
upbl: ## rebuild l'image et lance tous les services avec les logs
...
lapp: ## Affiche les logs de l'application
	$(DOCKER_COMPOSE) logs -f app

shapp: ## Ouvre un shell dans le container de l'application
